    ...
    <>
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
          <Typography variant="h3" component="h1" fontWeight="bold" className="text-gradient">
            Analytics Dashboard
          </Typography>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Button
              ...
              disabled={isLoading}
              sx={{ mr: 2, borderColor: 'rgba(255,255,255,0.2)' }}
            >
              Export Data
            </Button>
        ...
        {activeTab === 0 && (
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Paper className="glass-card" sx={{ height: '100%', p: 3, position: 'relative', overflow: 'hidden' }}>
                <Box sx={{ position: 'absolute', top: -20, right: -20, width: 100, height: 100, borderRadius: '50%', background: 'radial-gradient(circle, rgba(139, 92, 246, 0.2) 0%, transparent 70%)' }} />
                <Typography variant="h6" color="textSecondary" gutterBottom>
                  Total Study Time
                </Typography>
                <Typography variant="h3" component="div" fontWeight="bold" sx={{ color: '#8b5cf6', textShadow: '0 0 20px rgba(139, 92, 246, 0.3)' }}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Paper className="glass-card" sx={{ height: '100%', p: 3, position: 'relative', overflow: 'hidden' }}>
                <Box sx={{ position: 'absolute', top: -20, right: -20, width: 100, height: 100, borderRadius: '50%', background: 'radial-gradient(circle, rgba(236, 72, 153, 0.2) 0%, transparent 70%)' }} />
                <Typography variant="h6" color="textSecondary" gutterBottom>
                  Subjects
                </Typography>
                <Typography variant="h3" component="div" fontWeight="bold" sx={{ color: '#ec4899', textShadow: '0 0 20px rgba(236, 72, 153, 0.3)' }}>
                  {subjects.length}
                </Typography>
              </Paper>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Paper className="glass-card" sx={{ height: '100%', p: 3, position: 'relative', overflow: 'hidden' }}>
                <Box sx={{ position: 'absolute', top: -20, right: -20, width: 100, height: 100, borderRadius: '50%', background: 'radial-gradient(circle, rgba(6, 182, 212, 0.2) 0%, transparent 70%)' }} />
                <Typography variant="h6" color="textSecondary" gutterBottom>
                  Tasks Completed
                </Typography>
                <Typography variant="h3" component="div" fontWeight="bold" sx={{ color: '#06b6d4', textShadow: '0 0 20px rgba(6, 182, 212, 0.3)' }}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Paper className="glass-card" sx={{ height: '100%', p: 3, position: 'relative', overflow: 'hidden' }}>
                <Box sx={{ position: 'absolute', top: -20, right: -20, width: 100, height: 100, borderRadius: '50%', background: 'radial-gradient(circle, rgba(16, 185, 129, 0.2) 0%, transparent 70%)' }} />
                <Typography variant="h6" color="textSecondary" gutterBottom>
                  Study Sessions
                </Typography>
                <Typography variant="h3" component="div" fontWeight="bold" sx={{ color: '#10b981', textShadow: '0 0 20px rgba(16, 185, 129, 0.3)' }}>
